...
import { LiaBell, LiaCodepen, LiaFileImportSolid, LiaOptinMonster, LiaSpeakap, LiaSpeakerDeck } from "react-icons/lia";
import { FaMessage, FaMicrophone } from "react-icons/fa6";
{
  /* Find more icons */
}
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "300px" }}>
      ...
      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start">
        <LiaCodepen className="me-2 fs-5" />
        Choose Home Page
      </button>
      <br />
      <button className="btn btn-lg btn-secondary w-100 mt-1 text-start">
